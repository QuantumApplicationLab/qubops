...
class EmbeddedQUBOPS(QUBOPS):
    ...
    def create_embedded_qubo_dict(self):
        ...
        return (embedded_qubo_dict_tr, embedding, chains)
    ...
    def solve(self, matrix: np.ndarray, vector: np.ndarray):
        ...
        self.chain_break = chain_break_frequency(
            self.sampleset.record.sample, self.embedding
        )
